                ...
                forgotPasswordSuccess ?
                    <div className={styles.page}>
                        <form onSubmit={onSubmit}>
                            ...
                            />
                            <div className={'mb-6'}/>
                            <Input placeholder="Введите код из письма" value={form.token} name="token"
                                   onChange={onChange}/>
                            <div className={'mb-6'}/>
                            <Button type='primary'>Сохранить</Button>
                        </form>
                        <p className={'text text_type_main-default text_color_inactive mt-10 pt-10  mb-4'}>Вспомнили
                            пароль?
